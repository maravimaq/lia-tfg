...
export default function ForgotPasswordScreen() {
  ...
  const helperText = useMemo(() => {
    if (!sentEmail || statusMessage?.type !== "success") {
      return "Introduce tu email para recibir el enlace de recuperación.";
    }

    return `Hemos intentado enviar el enlace a ${sentEmail}. Revisa también spam o promociones.`;
  }, [sentEmail, statusMessage?.type]);
